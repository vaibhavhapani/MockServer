                ...
                if (localUser && timeDifferenceInMinutes >= 1) {
                  ...
                  prompt(
                    ...
                    },
                    {
                      onSuccess: function (context) {
                        ...
                        executeStep(
                          ...
                          },
                          {
                            onSuccess: function (context) {
                              Log.info(
                                "============== Step-10 PART B:Login with the basic authentication flow completed"
                              );
                            },
                          }
                        );
                        Log.info(
                          "============== Step-11: Finishing the consent flow on account linkning..."
                        );
                        prompt(
                          "finishAccountLink",
                          {
                          ...
                          },
                          {
                            ...
                            onFail: function (context, data) {
                              Log.info(
                                "============== Step-15: Error occurred while prompt - User Link Consent..."
                              );
                            },
                          }
                        );
                      ...
                      onFail: function (context, data) {
                        Log.info(
                          "============== Step-16: Error occurred while prompt - User Link Consent..."
                        );
                      },
                    }
                  );
...
// Local user is available.
Log.info(
  "============== Step-12: Local User found. UserName: " + localUser.username
);
var userStoreDomain = localUser.userStoreDomain;
// Associate local user with federated user.
doAssociationWithLocalUser(
...
Log.info(
  "============== Step-14: Associated local username: " + localUser.username
);
